                    ...
                    <tr>
                        ...
                        <td>
                            <img src="<?= BASE_ADMIN_URL . $product->image_url ?>" alt=""
                                ...
                                onerror="this.onerror=null;this.src='<?= BASE_ADMIN_URL . 'assets/img/default-150x150.png' ?>';">
                        </td>
                        ...
                        <td class="project-state">
                            <span
                                class="badge <?= $product->in_stock == 0 ? 'badge-danger' : 'badge-success'?>"><?= $product->in_stock == 0 ? 'Hết hàng': 'Đang bán' ?></span>
                        </td>
                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" target="_blank"
                                href="<?= BASE_URL ?>san-pham/<?= $product->slug ?>">
                                <i class="fas fa-folder">
                                </i>
                                Xem
                            </a>
                            <a class="btn btn-info btn-sm"
                                href="<?= BASE_ADMIN_URL?>san-pham?action=detail&id=<?= $product->id ?>">
