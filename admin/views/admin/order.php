            ...
            <table class="table table-striped projects">
                ...
                if(count($orders) === 0){ ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <p><span class="badge badge-<?=  ($order['status'] == 2) ? "success" : "danger" ?>">
                                    <?=  $this->orderRepository->statusOrder($order['status']) ?></span></p>
                        </td>

                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm"
                                href="<?= BASE_ADMIN_URL ?>don-hang?action=detail&id=<?= $order['id'] ?>">
