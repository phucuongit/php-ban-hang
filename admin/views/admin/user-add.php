<section class="content">
    <form action="<?= BASE_ADMIN_URL . (isset($user) ? 'user?action=edit' : 'user/them-moi?action=add')  ?>"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" placeholder="Nhập username" class="form-control"
                                <?= @(isset($user) ? 'disabled' : '') ?> value="<?= @$user['username'] ?>" />
                        </div>
                        <div class="form-group">
        ...
        <?php }?>
        <a class="form-control submit_product btn-danger" href="<?= BASE_ADMIN_URL . 'user'?>">Trở lại</a>
