<section class="content">
    ...
    <form
        action="<?= BASE_ADMIN_URL . (isset($product) ? 'san-pham/them-moi?action=edit' : 'san-pham/them-moi?action=add')?>"
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên sản phẩm" name="title" class="form-control"
                                value="<?= @$product['title'] ?>" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="in_stock" placeholder="Nhập số lượng kho" class="form-control"
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio"
                                    ...
                                    name="category_id" id="category<?= $category->id ?>" value="<?= $category->id ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?=BASE_ADMIN_URL . @$product['image_url'] ?>" alt="image_product"
                                style="max-width: 100%">
                            <?php } ?>
                        </div>
                    </div>
                </div>
                <button type="submit" class="form-control submit_product btn-primary"
                    style="margin-bottom: 1rem;">Lưu</button>
            </div>
