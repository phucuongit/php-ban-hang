                    ...
                    <div class="col-lg-4 footer_social">
                        <div class="footer_icon social_icon">
                            <ul class="list-unstyled">
                                <li>
                                    <a href="https://www.facebook.com/phucuong2106/" target="_blank"
                                        class="single_social_icon" rel="noopener noreferrer"><i
                                            class="fab fa-facebook-f"></i></a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/lpcuong2106" target="_blank" class="single_social_icon"
